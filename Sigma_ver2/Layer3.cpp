...
#define DATA_DIMENSION 100
#define MINI_BATCH_SIZE 100

int main3(){

	string file_path = "influenza_HA\\save_data\\512-100-512\\";
	...
	Input_Layer input;
	Fully_Connect_Layer middle(20, relu, 0, 0.01f), output(100, relu, 0, 0.01f);
	...
	Optimizer opt;
	opt.learning_rate_ = 0.000001;

	model.set_optimizer(opt);

	ofstream delta("influenza_HA\\save_data\\100-20-100\\layer3_delta.csv", ios::app | ios::out);
	...
	string dir_path = "influenza_HA\\save_data\\100-20-100\\"; //結果を出力するファイルの場所を指定
